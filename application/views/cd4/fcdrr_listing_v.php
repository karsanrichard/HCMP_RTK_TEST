          ...
          <tbody>
            ...
            foreach ($lab_order_list as $order) {
              ...
              <tr>
                ...
                <td>
                <a href="<?php echo site_url('cd4_management/fcdrr_details/' . $order['id']); ?>"class="link">View</a>
                    <!-- <a href="<?php echo site_url('rtk_management/edit_lab_order_details/' . $order['id']); ?>"class="link report">| Edit</a> -->
                    </td>
              </tr> 
              <?php
            }

...
/* End of Validation for Tests for Screening Determine */
    ...
    function compute_closing(row){
        ...
        if((q_used+neg_adj)>(b_bal+qty_rcvd+pos_adj)){
            ...
            $('#q_received_oth' + row).css('border-color','red'); 
            $('#q_used_' + row).css('border-color','red'); 
            $('#tests_done_' + row).css('border-color','red'); 
...
//    $phone_no = $detail['telephone'];
    ...
    echo form_open('cd4_management/update_lab_commodity_orders',$attributes); 
        ?>
...
<div id="dialog-form" title="Lab Commodities Order Report">
    ...
    <form>
        <table id="user_order" width="10%" class="data-table">
            <input  type="hidden" name="facility_name" colspan = "3" style = "color:#000; border:none" value="<?php echo $facility_name ?>">
            <input  type="hidden" name="order_id" colspan = "3" style = "color:#000; border:none" value="<?php echo $order_id ?>">
            
            <input type="hidden" name="facility_code" colspan = "2" style = "color:#000; border:none" value="<?php echo $facility_code ?>">
            <input type="hidden" name="district_name" colspan = "2" style = "color:#000; border:none" value="<?php echo $district ?>">
            <input type="hidden" name="county" colspan = "3" style = "color:#000; border:none" value="<?php echo $county ?>">
            <tr>
                ...
                <td colspan = "6" rowspan = "7" style="background: #fff;"></td>
            </tr>
            <tr >
            ...
            <tr>
                ...
                <td><input class='user2'class='user2' id="calibur_pead" name="calibur_pead" colspan = "2" style = "color:#000" value="<?php echo $detail['calibur_pead']; ?>" </td>
                <td><input class='user2'class='user2' id="calibur_adult" name="calibur_adult" colspan = "2" style = "color:#000" value="<?php echo $detail['calibur_adults']; ?>"</td>
                <td rowspan = "1">Total Tests Done</td>   
                <td><input class='user2'class='user2' id="total_tests" name="total_tests" colspan = "2" style = "color:#000" value="<?php echo $detail['total_tests']; ?>"></td>                    
            ...
            <tr>
                ...
                <td><input class='user2'class='user2' id="count_pead" name="count_pead" colspan = "2" style = "color:#000" value="<?php echo $detail['count_pead']; ?>"></td>
                <td><input class='user2'class='user2' id="count_adult" name="count_adult" colspan = "2" style = "color:#000" value="<?php echo $detail['count_adults']; ?>"></td> 
                <td rowspan = "1">Adults Below 500 CD4 count</td>   
                <td><input class='user2'class='user2' id="adults_bel_cl" name="adults_bel_cl" colspan = "2" style = "color:#000" value="<?php echo $detail['adults_bel_cl']; ?>"></td>         

            </tr>
            <tr>
                <td colspan = "2" style = "text-align:right"><b>Beginning:</b></td> 
                <td><input class='my_date'id="begin_date" name="begin_date" colspan = "2" size="10" type="text" value="<?php echo $detail['beg_date']; ?>"/></td>
                <td colspan = "2"><b>Cyflow Partec</b></td>
                <td><input class='user2'class='user2' id="partec_pead" name="partec_pead" colspan = "2" style = "color:#000" pvalue="<?php echo $detail['cyflow_pead]']; ?>"</td>
                <td><input class='user2'class='user2' id="partec_adult" name="partec_adult" colspan = "2" style = "color:#000" value="<?php echo $detail['cyflow_adults']; ?>"</td>
                <td rowspan = "1">Peads Below 500 CD4 count</td>   
                <td><input class='user2'class='user2' id="pead_bel_cl" name="pead_bel_cl" colspan = "2" style = "color:#000" value="<?php echo $detail['pead_bel_cl']; ?>"></td>  
            </tr>
            <tr>
                <td colspan = "2" style = "text-align:right"><b>Ending:</b></td>
                <td><input class='my_date'id="end_date" name="end_date" colspan = "2" size="10" type="text" value="<?php echo $detail['end_date']; ?>"/></td>
                <td colspan = "2"><b>Alere PIMA</b></td>
                <td colspan = "2"><input id="pima" name="pima" colspan = "4" style = "color:#000; width: 100% !important;" value="<?php echo $detail['pima_tests']; ?>" size="20"> </td>  
                <td colspan = "2" style="text-align:center"><b></b></td>                     
            </tr>
            <tr >
                <td colspan = "3"></td>
                <td colspan = "2"><b>Facs Presto</b></td>
                <td colspan = "2"><input  id="presto" name="presto" colspan = "4" style = "color:#000; width: 100%;" pvalue="<?php echo $detail['presto_tests']; ?>" size="20"> </td>  
                <td colspan = "2" style="text-align:center"><b></b></td>
                
            </tr>
                <tr><td colspan = "16" rowspan="1" ></td></tr>
                <tr>
                        <td colspan = "16" style = "text-align:center; font-size:16px;" id="calc">
...
<tr>                    
                        <td colspan = "16"><input colspan = "16" id="explanation" name="explanation" size="210" type="text" value="<?php if($explanation ==''){echo "None";}else {echo $explanation;}?>" style=" width: 90%;"/></td>
...
<tr>                    <td colspan = "4" style = "text-align:left">Compiled by: <?php echo $compiled_by?><input name="compiled_by" value ="<?php if($compiled_by == '' || $compiled_by =='0'){echo "Not Specified";} else{ echo $compiled_by;}?>" /></td>

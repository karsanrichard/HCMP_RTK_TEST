...
<div class="row" style="width: 100%;float: right;margin-top:60px;text-align:center">
	...
	<div class="span3 extra" style="width:20%;float:left">
		<span>
		<a href="<?php echo base_url().'rtk_management/get_all_zone_a_facilities/B';?>">
			ZONE B 
		</a>
		</span>	<br>
		<div class="progress progress-info"><div class="bar" style=""></div></div>
	...
	<div class="span3 extra" style="width:20%;float:left">
		<span>
		<a href="<?php echo base_url().'rtk_management/get_all_zone_a_facilities/C';?>">
			ZONE C 
		</a>
		</span>	<br>
		<div class="progress progress-info"><div class="bar" style=""></div></div>
	...
	<div class="span3 extra" style="width:20%;float:left">
		<span>
		<a href="<?php echo base_url().'rtk_management/get_all_zone_a_facilities/D';?>">
			ZONE D 
		</a>
		</span>	<br>
		<div class="progress progress-info"><div class="bar" style=""></div></div>

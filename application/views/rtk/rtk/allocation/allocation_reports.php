...
<div class="clc_contents">
	...
	<!--by zone-->
					<div id="percentage_national" class="table_divs panel panel-success">
					  <div class="panel-heading accordion-heading " data-toggle="collapse" data-parent="#accordion2" href="#by_zone" style="font-size:13px;font-weight:bold" >BY ZONE: <i>(Click to View)</i></div>
					  <div id="by_zone" class="accordion-body collapse">
					  <div class="accordion-inner inner_div_height">
						  <button id="btn_zone_a" class=" btn btn-success">ZONE A</button>&nbsp;&nbsp;&nbsp;
						  <button id="btn_zone_b" class=" btn btn-success">ZONE B</button>&nbsp;&nbsp;&nbsp;
						  <button id="btn_zone_c" class=" btn btn-success">ZONE C</button>&nbsp;&nbsp;&nbsp;
						  <button id="btn_zone_d" class=" btn btn-success">ZONE D</button>
			...
			<!--by county-->
				<div class="accordion-group inner_divs">
					<div id="percentage_national" class="table_divs panel panel-success">
					  <div class="panel-heading accordion-heading " data-toggle="collapse" data-parent="#accordion2" href="#by_county" style="font-size:13px;font-weight:bold" >BY COUNTY: <i>(Click to View)</i></div>
					  <div id="by_county" class="accordion-body collapse">
					  <div class="accordion-inner inner_div_height">

						<select id="county_select" class="form-control" style="width:15%;float:left;height:30px;font-size:12px;">
							<option value="0"> -- Select County--</option>							
						</select>&nbsp;&nbsp;&nbsp;
               			 <button type="button" id="btn_county_select" class="btn btn-primary my_navs">Download County Report</button>

...
<div id="dialog-form" title="Enter the lab commodity details here">
 ...
 -->
            ...
            <tr><td ><input class='user2'id="compiled_by" name="compiled_by" size="10" type="text" colspan = "3"/>
                ...
                <td colspan = "1"><br/></td>
                <td colspan = "1"><br/></td>
                <td colspan = "3"><input class='user2'id="compiled_date" name="compiled_date" size="10" type="text" colspan = "2"/></td>
            </tr>
            ...
            <tr>                    <td><input class='user2'id="approved_by" name="approved_by" size="10" type="text" colspan = "2"/>
                ...
                <td colspan = "1"><br/></td>                
                <td colspan = "3"><input class='user2'id="approved_date" name="approved_date" size="10" type="text" colspan = "2"/></td>
            </tr>

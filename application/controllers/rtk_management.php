...
public function get_lab_report($order_no, $report_type) {
    ...
    <table class="data-table" width="100%">
        ...
        //first month               
                ...
                $sql_c = "SELECT commodity_name FROM hcmp_rtk_test.lab_commodities where category='1' and id='$commodity_id'";
                $result_c = $this->db->query($sql_c)->result_array();   
                $sql_all_c = "SELECT * FROM hcmp_rtk_test.lab_commodities where category='1'";
...
public function national_reporting_rates() {
    ...
    <style>table.data-table {border: 1px solid #DDD;font-size: 13px;border-spacing: 0px;}
        ...
        //$county = $value['county'];
                            ...
                            $sql_u = "SELECT email FROM hcmp_rtk_test.user where usertype_id = 13 and county_id='$county_id'";
        ...
        //$this->sendmail($html_data,$message, , $email_address);
                                                                                                                ...
                                                                                                                public function partner_detailed_summary($partner_id) {
                                                                                                                    ...
                                                                                                                    $sql_u = "SELECT email FROM hcmp_rtk_test.user where usertype_id = 14 and partner='$partner_id'";

<?php
class Cd4_Fcdrr extends Doctrine_Record {
	public function setTableDefinition() {
		...
		$this -> hasColumn('year','int');
		$this -> hasColumn('month','int');
		$this -> hasColumn('calibur_adults','int');
		$this -> hasColumn('calibur_pead','int');
		$this -> hasColumn('caliburs','int');
		$this -> hasColumn('count_adults','int');
		$this -> hasColumn('count_pead','int');
		$this -> hasColumn('counts','int');
		$this -> hasColumn('cyflow_adults','int');
		$this -> hasColumn('cyflow_pead','int');
		$this -> hasColumn('cyflows','int');
		$this -> hasColumn('pima_tests','int');
		$this -> hasColumn('presto_tests','int');
		$this -> hasColumn('adults_bel_cl','int');
		$this -> hasColumn('pead_bel_cl','int');
...
public static function getlastid(){
	$query = Doctrine_Manager::getInstance()->getCurrentConnection()
	->fetchAll("SELECT id FROM cd4_fcdrr ORDER by id");
	return $query;
}
